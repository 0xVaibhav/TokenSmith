  ...
  const Section1 = [
    {
      ...
      desc: "Discover the clarity of modern crypto portfolios with TokenSmith – where simplicity meets smart investing, making the crypto landscape accessible to all. Expert-Crafted Strategies:",
    },
    {
      icon: "/icons/section-1/Strategy.png",
      name: "Expert-Crafted Strategies",
      desc: "Unlock the power of expert insights with TokenSmith , as our crypto portfolios are meticulously crafted by industry professionals, ensuring a foundation rooted in comprehensive research.",
    },
    {
      icon: "/icons/section-1/Crypto.png",
      name: "Your Crypto, Your Way",
      desc: "Experience the freedom of personalized crypto investments with TokenSmith. Tailor your portfolio effortlessly, creating a unique strategy that aligns perfectly with your financial goals.",
    },
  ];
  const Section2 = [
    {
      ...
      <section className="flex flex-col items-center justify-center gap-8 p-6 py-12 md:px-24 md:py-36">
        <div className="flex flex-col items-center justify-center gap-2">
          <h2 className="text-3xl gradient-title md:text-4xl">
            There is a Crafted Token Smith for everyone
          </h2>
          <p className="text-xl">
